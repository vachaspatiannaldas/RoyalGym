...
if (isset($_POST['flat_submit'])) {
 ...
 $file_store = "img/" . $image;
 if (move_uploaded_file($file_temp_loc, $file_store)) {
  $sql = "INSERT INTO `sup`( `name`,`temp_data`,`link`, `a_image`) VALUES ('$name','$temp_data','$link','$image')
  ";
 ...
 <div class="container my-5">
  <div class="row">
   <div class="col-sm-4 mx-auto d-block bg-light">
    <h3 class="text-center text-info">Suppliment Details</h3>
    <form action="" method="post" enctype="multipart/form-data">
     ...
     <div class="form-group">
      ...
      <input id="mobile" class="form-control" type="text" name="link">
     </div>
