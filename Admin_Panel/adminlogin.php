<?php
  ...
  if(isset($_POST['bt1']))
  {
    ...
    $userid=$_POST['t1'];
    $pass=$_POST['t2'];
    $sql="select * from login where userid='$userid' && pass='$pass'";
              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <img src="img/gym.png" style="width:80px; height:75px;" alt="">
                    <h1 class="h4 text-gray-900 mb-4">ROYAL GYM ADMIN</h1>
                  </div>
                  <form class="user" method="POST" action="">
                    <div class="form-group">
                      <input type="text"  class="form-control form-control-user" name="t1" aria-describedby="emailHelp" placeholder="User Id">
                    </div>
                    <div class="form-group">
                      <input type="password" class="form-control form-control-user"  name="t2" placeholder="Password">
                    </div> 
                   <center><div> 
