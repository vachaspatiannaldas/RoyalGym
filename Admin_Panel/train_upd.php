                  ...
                  <div class="col-lg-12">
                    <div class="p-5">
                      <div class="text-center">
                        <h1 style="color:#4e73df"><b>Trainer</b></h1>
                      ...
                      <?php
                        ...
                        $sql1="select * from trainer where id='$id' ";
                        ...
                        while($row=mysqli_fetch_row($rs1))
                          ...
                          <div class='form-group'>
                                <input type='text' class='form-control form-control-user' name='t2'  placeholder='Trainer Name' value='$row[1]'/>
                          </div>
                          <div> 
 ...
 <?php   
	...
	//mysqli_select_db($conn,"dashboard");
      ...
      $tname=$_POST['t2'];
        ...
        $sql="UPDATE trainer set tname='$tname' where id='$id' ";  
